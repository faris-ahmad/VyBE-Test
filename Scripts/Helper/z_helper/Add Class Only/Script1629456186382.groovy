...
WebUI.uploadFile(findTestObject('Page_Add_Class/upload_picture 384x240'), 'Universe/Users/farisharunahmad/Downloads/Banana seedling(384x240).jpeg')
...
WebUI.uploadFile(findTestObject('Page_Add_Class/upload_file_on_class_materials'), 'Universe/Users/farisharunahmad/Downloads/farmerbook.pdf')

WebUI.click(findTestObject('Page_Add_Class/class_schedule(plus)'))

WebUI.sendKeys(findTestObject('Page_Add_Class/choose_date_on_class_schedule'), Keys.chord(Keys.CONTROL, 'a', Keys.BACK_SPACE))

WebUI.setText(findTestObject('Page_Add_Class/choose_date_on_class_schedule'), '2021-07-15')

WebUI.sendKeys(findTestObject('Page_Add_Class/choose_start_time_on_class_schedule'), Keys.chord(Keys.CONTROL, 'a', Keys.BACK_SPACE))

WebUI.setText(findTestObject('Page_Add_Class/choose_start_time_on_class_schedule'), '14:00')
