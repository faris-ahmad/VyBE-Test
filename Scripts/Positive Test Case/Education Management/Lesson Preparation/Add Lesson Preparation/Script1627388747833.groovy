...
WebUI.callTestCase(findTestCase('Positive Test Case/Education Management/Lesson Preparation/Delete Lesson Preparation (dependent)'), [:], FailureHandling.STOP_ON_FAILURE)
